...
import ProcessPaymentHandler from './components/cobalt-bank-operations-payment-gateway-process-payment-handler';
...
const Label         = ({ label }) => (
	...
	<div className = "cobalt-bank-operations-payment-label__icons">
		<img src   = {claveUrl} alt = "Clave" className = "cobalt-bank-operations-payment-label__icon"/>
	</div>
	</div>
);

const settings = {
	name: 'cobalt_bank_operations_payment_gateway_telered_gateway',
	...
	paymentMethodId: 'cobalt_bank_operations_payment_gateway_telered_gateway',
