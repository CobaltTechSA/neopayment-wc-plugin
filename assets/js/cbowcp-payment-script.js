    ...
    jQuery( function( $ ) {
        ...
        function addBrowserData() {
            ...
            for (let p in navParams) {
                let el = `<input class="cbowcp-standard-gateway-browser" type="hidden" name="${p}" value="${navParams[p]}" />`;
                console.log(el);
                payForm.append(el);
            }
        }
        ...
        function removeBrowserData() {
            ...
            $('.cbowcp-standard-gateway-browser').remove();
        }
        ...
        $(document).ready( function() {
            setTimeout(_ => {
                let onPaymentMethodChange = function (paymentMethod) {
                    ...
                    if (paymentMethod === 'cbowcp_standard_gateway') {
                        addBrowserData();
                    } else {
                        removeBrowserData();
                    }
