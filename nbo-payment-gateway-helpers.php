<?php
/**
 * Helpers for NBO Payment Gateway plugin.
 *
 ...
 * @return bool
 */
function nbo_payment_gateway_is_valid_luhn( $number ) {
	if ( empty( $number ) ) {
		return false;
	}
 ...
 * @return bool
 */
function nbo_payment_gateway_is_valid_expiry_date( $expiry_date ) {
 ...
 * @return bool
 */
function nbo_payment_gateway_is_valid_card_holder( $card_holder ) {
 ...
 * @return bool
 */
function nbo_payment_gateway_is_valid_cvv( $cvv ) {
	if ( empty( $cvv ) ) {
		return false;
	}
 ...
 * @return string "state
 */
function nbo_payment_gateway_parse_state( $state ) {
