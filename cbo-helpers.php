 ...
 * @return bool
 */
function cbo_is_valid_luhn($number) {
    if (empty($number)) {
        return false;
    }
 ...
 * @return bool
 */
function cbo_is_valid_expiry_date($expiry_date) {
 ...
 * @return bool
 */
function cbo_is_valid_card_holder($card_holder) {
