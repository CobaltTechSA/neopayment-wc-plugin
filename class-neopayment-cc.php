...
/**
 * Credic Card class for Neopayment plugin.
 *
 * @package NEOPAYMENT
 */
 ...
 */
class NEOPAYMENT_CC extends WC_Payment_Gateway_CC {

	/**
	 * Class constructor.
	 */
	public function __construct() {
		add_filter( 'woocommerce_credit_card_form_fields', array( $this, 'neopayment_reorder_credit_card_fields' ), 20, 2 );
	}
	 ...
	 */
	public function neopayment_reorder_credit_card_fields( $fields, $gateway_id ) {
	 ...
	 * @return string
	 */
	public function neopayment_field_name( $name ) {
	...
	public function form() {
		...
		$card_holder_field = '<p class="form-row form-row-wide">
            <label for="' . esc_attr( $this->id ) . '-card-holder">' . esc_html__( 'Card holder', 'neopayment' ) . '&nbsp;<span class="required">*</span></label>
            <input id="' . esc_attr( $this->id ) . '-card-holder" class="input-text wc-credit-card-form-card-holder" inputmode="text" autocomplete="cc-card-holder" autocorrect="no" autocapitalize="no" spellcheck="no" type="text" placeholder="' . esc_attr__( 'Card holder', 'neopayment' ) . '" ' . $this->neopayment_field_name( 'card-holder' ) . ' />
        </p>';

		$default_fields = array(
			'card-number-field' => '<p class="form-row form-row-wide">
                <label for="' . esc_attr( $this->id ) . '-card-number">' . esc_html__( 'Card number', 'neopayment' ) . '&nbsp;<span class="required">*</span></label>
